    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form class="w-full px-4 md:px-8 lg:px-12 py-6 flex justify-center" action="/search" method="get">                
                    <input class="w-4/5  border-gray-500 hover:ring-2 ring-gray-300" name='q' id='q' type="text" placeholder="Search">
